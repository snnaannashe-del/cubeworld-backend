...
async def join_cube_by_key(body: JoinCubeRequest):
    """Resolve a cube invite key ÃÂ¢ÃÂÃÂ returns cube info if valid."""
...
# user_ws: { user_id_str: websocket }  ÃÂ¢ÃÂÃÂ tracks the most recent WS for each user (for direct notifications)
...
# Ã¢ÂÂÃ¢ÂÂ Admin: reset DB to clean state Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
@app.post("/admin/reset-db")
async def reset_database(request: Request):
    conn = db.get_db()
    c = conn.cursor()
    ordered = ["dm_messages","messages","cube_members","group_messages","group_members","groups",
               "reward_claims","wallets","blockchain_txs","cube_transactions",
    ...
    for name,desc,icon,color in seeds:
        try: c.execute("INSERT INTO cubes (owner_id,name,description,icon,color,type,life_hours,expires_at) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)", (None,name,desc,icon,color,"public",999999,far))
        except Exception: pass
    conn.commit(); conn.close()
    return {"ok": True, "users": 0, "cubes": 8}
