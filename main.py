...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Pydantic models ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
class CreateGroupRequest(BaseModel):
    ...
    icon: Optional[str] = 'ÃÂ°ÃÂÃÂÃÂ¥'
...
async def generate_key(request: Request):
    ...
    # Store as pending ÃÂ¢ÃÂÃÂ user is NOT created until first entry into CubeWorld
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ User ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def create_signal_standalone(body: CreateSignalRequest, user=Depends(get_current_user)):
    """Standalone signal ÃÂ¢ÃÂÃÂ not tied to a specific cube."""
    try:
...
async def set_username(body: SetUsernameRequest, user=Depends(get_current_user)):
    ...
    if not re.match(r'^[a-z0-9_]{4,24}$', uname):
        raise HTTPException(400, "ÃÂÃÂ®ÃÂÃÂ·ÃÂÃÂµÃÂÃÂÃÂÃÂ½ÃÂÃÂµÃÂÃÂ¹ÃÂÃÂ¼: 4-24 ÃÂÃÂÃÂÃÂ¸ÃÂÃÂ¼ÃÂÃÂ²ÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂ°, ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂÃÂÃÂºÃÂÃÂ¾ a-z 0-9 _")
    ok = db.set_username(user["id"], uname)
    if not ok:
        raise HTTPException(409, "ÃÂÃÂ­ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ @username ÃÂÃÂÃÂÃÂ¶ÃÂÃÂµ ÃÂÃÂ·ÃÂÃÂ°ÃÂÃÂ½ÃÂÃÂÃÂÃÂ")
    return {"ok": True, "username": uname}

# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ User Search ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def search_users(q: str = "", limit: int = 20, user=Depends(get_current_user)):
    ...
    if not q.strip():
        raise HTTPException(400, "ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ¹ ÃÂÃÂ·ÃÂÃÂ°ÃÂÃÂ¿ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ")
    ...
    return [
        {
            ...
            "icon":   r.get("icon","ÃÂ°ÃÂÃÂ§ÃÂ"),
...
async def set_cube_handle(cube_id: int, body: SetCubeHandleRequest, user=Depends(get_current_user)):
    ...
    if not re.match(r'^[a-z0-9_]{3,24}$', handle):
        raise HTTPException(400, "Handle: 3-24 ÃÂÃÂÃÂÃÂ¸ÃÂÃÂ¼ÃÂÃÂ²ÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂ°, ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂÃÂÃÂºÃÂÃÂ¾ a-z 0-9 _")
    ok = db.set_cube_handle(cube_id, user["id"], handle)
    if not ok:
        raise HTTPException(409, "ÃÂÃÂ­ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ @handle ÃÂÃÂÃÂÃÂ¶ÃÂÃÂµ ÃÂÃÂ·ÃÂÃÂ°ÃÂÃÂ½ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂ»ÃÂÃÂ¸ ÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ²ÃÂÃÂ»ÃÂÃÂ°ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ»ÃÂÃÂµÃÂÃÂ")
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Premium ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def activate_premium(body: PremiumActivateRequest, user=Depends(get_current_user)):
    ...
    return {"ok": True, "message": f"Premium ÃÂÃÂ°ÃÂÃÂºÃÂÃÂÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂ½ ÃÂÃÂ½ÃÂÃÂ° {body.months} ÃÂÃÂ¼ÃÂÃÂµÃÂÃÂ."}

# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Activity tracking ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def activity_event(body: ActivityEventRequest, user=Depends(get_current_user)):
    ...
    # Milestone rewards ÃÂ¢ÃÂÃÂ award CUBE at activity milestones and notify via WS
    stats = db.get_my_activity_stats(user["id"])
    bonus = 0
    reason = ""
    if body.event == "message":
        ...
        if msgs > 0 and msgs % 10 == 0:
            bonus, reason = 5, f"+5 CUBE ÃÂÃÂ· {msgs} ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ¾ÃÂÃÂ±ÃÂÃÂÃÂÃÂµÃÂÃÂ½ÃÂÃÂ¸ÃÂÃÂ¹"
    elif body.event == "post":
        posts = stats.get("posts", 0)
        if posts > 0 and posts % 5 == 0:
            bonus, reason = 10, f"+10 CUBE ÃÂÃÂ· {posts} ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ²"
    elif body.event == "invite":
        invites = stats.get("invites", 0)
        if invites > 0 and invites % 1 == 0:
            bonus, reason = 50, "+50 CUBE ÃÂÃÂ· ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ°ÃÂÃÂ»"
    if bonus:
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Rewards ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def reward_claim(body: RewardClaimRequest, user=Depends(get_current_user)):
    ...
    return {"ok": True, "usd": amount, "wallet": body.wallet_address,
            "message": f"ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ²ÃÂÃÂºÃÂÃÂ° ÃÂÃÂ½ÃÂÃÂ° ${amount:.2f} ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ·ÃÂÃÂ´ÃÂÃÂ°ÃÂÃÂ½ÃÂÃÂ°. ÃÂÃÂÃÂÃÂÃÂÃÂ¿ÃÂÃÂ»ÃÂÃÂ°ÃÂÃÂÃÂÃÂ° ÃÂÃÂ² ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂµÃÂÃÂ½ÃÂÃÂ¸ÃÂÃÂµ 24ÃÂÃÂ."}
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Groups ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def create_group(body: CreateGroupRequest, user=Depends(get_current_user)):
    ...
    gid = db.create_group(user["id"], body.name.strip(), body.description or '', body.icon or 'ÃÂ°ÃÂÃÂÃÂ¥', gtype)
    if not gid:
...
async def join_group_by_key(body: JoinGroupByKeyRequest, user=Depends(get_current_user)):
    ...
    if not g:
        raise HTTPException(404, "ÃÂÃÂÃÂÃÂ»ÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂ¹ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½ ÃÂÃÂ¸ÃÂÃÂ»ÃÂÃÂ¸ ÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¿ÃÂÃÂ¿ÃÂÃÂ° ÃÂÃÂ½ÃÂÃÂµÃÂÃÂ´ÃÂÃÂ¾ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ°")
...
async def set_group_key(group_id: int, body: SetGroupKeyRequest, user=Depends(get_current_user)):
    ...
    if not ok:
        raise HTTPException(403, "ÃÂÃÂ¢ÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂÃÂÃÂºÃÂÃÂ¾ ÃÂÃÂ²ÃÂÃÂ»ÃÂÃÂ°ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ»ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂ¾ÃÂÃÂ¶ÃÂÃÂµÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂ½ÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂºÃÂÃÂ»ÃÂÃÂÃÂÃÂ")
    return {"ok": True}
...
async def upload_file(file: UploadFile = File(...),
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Cloudinary upload (permanent) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Local temp storage (fallback) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Cubes CRUD ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def create_cube(body: CreateCubeRequest, user=Depends(get_current_user)):
    ...
    icon      = body.icon[:65536]  # allow full base64 photo (64ÃÂÃÂ64 JPEG ÃÂ¢ÃÂÃÂ 4KB)
    color     = body.color[:20]
...
async def update_cube_icon(cube_id: int, body: UpdateCubeIconRequest, user=Depends(get_current_user)):
    ...
    try:
        ...
        if c.rowcount == 0:
            conn.close(); raise HTTPException(status_code=403, detail="ÃÂÃÂ¢ÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂÃÂÃÂºÃÂÃÂ¾ ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ·ÃÂÃÂ´ÃÂÃÂ°ÃÂÃÂÃÂÃÂµÃÂÃÂ»ÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂ¾ÃÂÃÂ¶ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¾ÃÂÃÂ±ÃÂÃÂ½ÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂºÃÂÃÂ¾ÃÂÃÂ½ÃÂÃÂºÃÂÃÂ")
        conn.commit(); conn.close()
        return {"ok": True}
...
async def delete_cube(cube_id: int, user=Depends(get_current_user)):
    ...
    if not deleted:
        raise HTTPException(status_code=404, detail="ÃÂÃÂÃÂÃÂÃÂÃÂ± ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂ¹ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½ ÃÂÃÂ¸ÃÂÃÂ»ÃÂÃÂ¸ ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ²ÃÂÃÂ»ÃÂÃÂ°ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ»ÃÂÃÂµÃÂÃÂ")
    # Notify all members (visitors) that cube was deleted ÃÂ¢ÃÂÃÂ they'll remove it from their world
...
async def kick_user_from_cube(cube_id: int, request: Request, user=Depends(get_current_user)):
    ...
    # Check ownership directly ÃÂ¢ÃÂÃÂ works even on expired/inactive cubes
    conn = db.get_db()
    cur = conn.cursor()
    ...
    conn.close()
    if not row:
        raise HTTPException(404, "ÃÂÃÂÃÂÃÂÃÂÃÂ± ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂ¹ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½")
    row_owner = row["owner_id"] if db._PG else row[0]
    if int(row_owner) != int(user["id"]):
        raise HTTPException(403, "ÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ²ÃÂÃÂ»ÃÂÃÂ°ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ»ÃÂÃÂµÃÂÃÂ ÃÂÃÂºÃÂÃÂÃÂÃÂ±ÃÂÃÂ°")
...
async def get_cube_online_members(cube_id: int, user=Depends(get_current_user)):
    ...
    seen = {}
    # Banned users for this cube ÃÂ¢ÃÂÃÂ exclude from results
...
async def get_cube_memberships(user=Depends(get_current_user)):
    """Return cubes the user joined via key ÃÂ¢ÃÂÃÂ used to restore world after logout/login."""
    return db.get_user_joined_cubes(int(user["id"]))

@app.post("/cubes/join")
async def join_cube_by_key(body: JoinCubeRequest, request: Request):
    """Resolve a cube invite key ÃÂ¢ÃÂÃÂ returns cube info if valid. Records membership if authenticated."""
    import hashlib
    key = body.cube_key.strip().upper()
    cube = db.get_cube_by_key(key)
    if not cube:
        raise HTTPException(status_code=404, detail="ÃÂÃÂÃÂÃÂ»ÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµ ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂ¹ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½ ÃÂÃÂ¸ÃÂÃÂ»ÃÂÃÂ¸ ÃÂÃÂºÃÂÃÂÃÂÃÂ± ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂº")
    ...
    if db.is_device_banned_from_cube(cube["id"], ip_hash=ip_hash, device_id=device_id):
        raise HTTPException(status_code=403, detail="ÃÂÃÂÃÂÃÂ»ÃÂÃÂÃÂÃÂ ÃÂÃÂ½ÃÂÃÂµÃÂÃÂ´ÃÂÃÂµÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ¸ÃÂÃÂÃÂÃÂµÃÂÃÂ»ÃÂÃÂµÃÂÃÂ½ ÃÂÃÂ´ÃÂÃÂ»ÃÂÃÂ ÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂÃÂÃÂµÃÂÃÂ³ÃÂÃÂ¾ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ°")
...
async def get_cube_key(cube_id: int, user=Depends(get_current_user)):
    ...
    if key is None:
        raise HTTPException(status_code=403, detail="ÃÂÃÂ¢ÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂÃÂÃÂºÃÂÃÂ¾ ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ·ÃÂÃÂ´ÃÂÃÂ°ÃÂÃÂÃÂÃÂµÃÂÃÂ»ÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂ¾ÃÂÃÂ¶ÃÂÃÂµÃÂÃÂ ÃÂÃÂ²ÃÂÃÂ¸ÃÂÃÂ´ÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂºÃÂÃÂ»ÃÂÃÂÃÂÃÂ")
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Global Video Feed ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Cube Posts (legacy) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Admin / Stats ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Prices proxy (server-side CoinGecko cache ÃÂ¢ÃÂÃÂ prevents per-user rate limits) ÃÂ¢ÃÂÃÂ
_prices_cache: dict = {}
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ WebSocket: per-cube rooms ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
# cube_rooms: { cube_id_str: { user_id_str: {"ws": websocket, "display_name": str} } }
# global_user_ws: { user_id_str: websocket }  ÃÂ¢ÃÂÃÂ ALWAYS-ON global /ws/{token} connection
# user_ws: { user_id_str: websocket }  ÃÂ¢ÃÂÃÂ most recent WS (cube / group / global)
# _notify_user uses global_user_ws so cube-room disconnects never lose the channel.

cube_rooms: Dict[str, Dict[str, dict]] = {}
global_user_ws: Dict[str, object] = {}   # ÃÂ¢ÃÂÃÂ persistent across cube join/leave
...
async def ws_cube(websocket: WebSocket, token: str, cube_id: str):
    ...
    try:
        ...
        cube_rooms[cube_id][user_id] = {
            ...
            "ip": ws_client_ip, "device_id": ws_device_id  # stored for kick ÃÂ¢ÃÂÃÂ ban
        }
        user_ws[user_id] = websocket  # track cube WS (for cube-specific sends)
        # NOTE: global_user_ws is NOT updated here ÃÂ¢ÃÂÃÂ it's managed only by /ws/{token}
        ...
        while True:
            ...
            if msg_type == "ping":
                ...
                # {type:"react", msg_id:X, emoji:"ÃÂ°ÃÂÃÂÃÂ"}
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ WebSocket: group chat room ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
@app.websocket("/ws/group/{token}/{group_id}")
async def ws_group(websocket: WebSocket, token: str, group_id: str):
    """Real-time WebSocket for group chat ÃÂ¢ÃÂÃÂ receives group_msg broadcasts."""
    await websocket.accept()
    user_id = None
    try:
        payload      = decode_access_token(token)
...
async def websocket_legacy(websocket: WebSocket, token: str):
    """Global user WebSocket ÃÂ¢ÃÂÃÂ for DM delivery when user is not in any cube."""
    await websocket.accept()
    user_id = None
    try:
        payload = decode_access_token(token)
